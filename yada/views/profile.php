...
<form action="<?php echo HOST . 'index.php?user=profile' ?>" method="post">
    <table class="datatable">
        ...
        <tr>
            ...
            <td>
                <select name="activity_level" id="activity_level">
                    <option value="1.9" <?php echo $user->getActivityLevel() == 1.9 ? ' selected="selected"' : '' ?> >Extra Active</option>
                    <option value="1.725" <?php echo $user->getActivityLevel() == 1.725 ? ' selected="selected"' : '' ?> >Highly Active</option>
                    <option value="1.55" <?php echo $user->getActivityLevel() == 1.55 ? ' selected="selected"' : '' ?> >Active</option>
                    <option value="1.375" <?php echo $user->getActivityLevel() == 1.375 ? ' selected="selected"' : '' ?> >Moderately Active</option>
                    <option value="1.2" <?php echo $user->getActivityLevel() == 1.2 ? ' selected="selected"' : '' ?> >Sedentary</option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr><td>Calorie Needed:</td><td><?php echo $calories; ?></td></tr>
        <tr>
            <td></td>
            <td>
